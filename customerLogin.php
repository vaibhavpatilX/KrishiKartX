...
<body>
    <div class="container">
        <div class="box-2">
            <h2 style="font-size: 30px; text-align: center; margin-bottom: 40px; margin-top:5px; font-weight: bold;">Customer Login</h2>
            <form action="customerLoginBackend.php" method="post">
                <div class="role-buttons" role="group" aria-label="Role selection">
                    ...
                    <a href="customerLogin.php" class="btn btn-secondary" role="button" style=" background:linear-gradient(to right, #1e3c72, #2a5298);" >Customer</a>
                </div>
                ...
                <p> <a href="customerReg.php"  style="font-weight: bold; color: #24C6DC; text-decoration:none;">New Customer Registration</a></p> 
            </form>
        </div>
    </div>
</body>

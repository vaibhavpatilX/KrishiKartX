                                ...
                                <div class="productCard_leftSide clearfix">
                                    ...
                                    <div class="sliderBlock">
                                        <ul class="sliderBlock_items">
                                            ...
                                            <img src="data:image/PNG;base64,<?php echo $ProductImg;?>" alt="hii"></img>
                                            </li>
                            ...
                            <div class="small-12 large-6 columns">
                                <div class="productCard_rightSide">
                                    ...
                                    <div class="block_product">
                                        <h2 class="block_name block_name__mainName"><?php echo $ProductName;?><sup> </sup></h2>
                                        <h2 class="block_name block_name__addName"><?php echo $ProductCategory;?></h2>
                                            ...
                                            <div class="row ">
                                                <div class="large-6 small-12 column left-align">
                                                    <div class="block_price">
                                                        <p class="block_price__currency"><?php echo $ProductPrice;?> ₹</p>
                                                ...
                                                <div class="large-6 small-12 column end">
                                                   <form method="post" action="bill.php">
                                                    <input type="hidden" name="qauntity" value="1" class="qnt">
                                                    <input type="hidden" name="FarmerId" value="<?php echo $FarmerId;?>">
                                                    <input type="hidden" name="ProductId" value="<?php echo $ProductId;?>">
                                                   
                                                    <button type="submit" name="submit" class="button button_addToCard">
                                                       Checkout
                                                    </button>
                                                   </form>
                                                </div>
...
var up = document.getElementsByClassName('block_quantity__up')[0],
    ...
    qnt = document.getElementsByClassName('qnt')[0];

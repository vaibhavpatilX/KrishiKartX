    ...
    <div class="menu_container">
        <div class="menu_items">
            <ul class="menu_item">
                ...
                <li class="item">
                    <a href="MyProducts.php" class="link flex">
                        <i class="bi bi-collection"></i>
                        <span>My Products</span>
                    </a>
                </li>
                <li class="item">
                    <a href="ManageOrders.php" class="link flex">
                ...
                <li class="item">
                    <a href="Payment.php" class="link flex">
                ...
                <li class="item">
                    <a href="farmerProfile.php" class="link flex">

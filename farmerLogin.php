...
<body>
    <div class="container">
        ...
        <div class="box-2">
            <h2 style="font-size: 30px; text-align: center; margin-bottom: 40px; margin-top:5px; font-weight: bold;">Farmer Login</h2>
            <form action="farmerLoginBackend.php" method="post">
                <div class="role-buttons" role="group" aria-label="Role selection">
                    <a href="adminLogin.php" class="btn btn-secondary" role="button" >Admin</a>
                    <a href="farmerLogin.php" class="btn btn-secondary" role="button" style="  background:linear-gradient(to right, #1e3c72, #2a5298);">Farmer</a>
                ...
                <p> <a href="FarmerReg.php" onclick="forgotPassword()" style="font-weight: bold; color: #007BFF; text-decoration:none;">New Farmer Registration</a></p> 
            </form>
        </div>
        </div>
    </div>

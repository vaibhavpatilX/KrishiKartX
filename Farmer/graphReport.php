...
$sql_total = "SELECT * FROM `order` WHERE FarmerId=$FarmerId";
$result_total = $conn->query($sql_total);
$totalOrders = $result_total->num_rows;

$sql_pending = "SELECT * FROM `order` WHERE FarmerId=$FarmerId AND OrderStatus='Pending'";
$result_pending = $conn->query($sql_pending);
$PendingOrders = $result_pending->num_rows;

$sql_delivered = "SELECT * FROM `order` WHERE FarmerId=$FarmerId AND OrderStatus='Delivered'";
$result_delivered = $conn->query($sql_delivered);
$DeliveredOrders = $result_delivered->num_rows;

$sql_canceled = "SELECT * FROM `order` WHERE FarmerId=$FarmerId AND OrderStatus='Canceled'";
$result_canceled = $conn->query($sql_canceled);
$CanceledOrder = $result_canceled->num_rows;

$sql_income = "SELECT SUM(TotalBill) AS TotalIncome FROM `order` WHERE FarmerId=$FarmerId AND PaymentStatus='Done'";
...
$sql_qr = "SELECT SUM(TotalBill) AS QrIncome FROM `order` WHERE FarmerId=$FarmerId AND PaymentMethod='Qr Code' AND PaymentStatus='Done'";
...
$sql_razorpay = "SELECT SUM(TotalBill) AS Razorpay FROM `order` WHERE FarmerId=$FarmerId AND PaymentMethod='Razorpay' AND PaymentStatus='Done'";
...
<body>
  <?php
  include_once "farmerSidebar.php";

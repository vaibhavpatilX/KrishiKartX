...
<head>
   ...
   <style type="text/css">
    body{ background: url(images/registration.jpg) no-repeat;
...
<body>
    <div class="container"  style="max-height: 700px;">
        <div class="box-2">
            <h2 style="font-size: 27px; text-align: center; margin-bottom: 30px; margin-top:20px; font-weight: bold;">Customer Registration</h2>
            <form id="registrationForm"   action="CustomerRegBackend.php" method="POST">
            <div class="main-user-info">
                ...
                <div class="form-submit-btn">
                    ...
                    onclick="window.location.href='customerLogin.php'">Back</button>
                </div>

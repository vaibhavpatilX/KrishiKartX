...
<?php include_once "navbar.php"; ?>
     ...
     <div class="main">
  <h1><b>Experience the joy of spreading happiness in an organic way with our range of health-enriching products.</b></h1>
  <ul class="cards">
  <?php $result = $conn->query("SELECT * FROM product WHERE ProductStatus='True'"); 
 if($result){
